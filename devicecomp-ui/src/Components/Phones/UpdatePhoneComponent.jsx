      ...
      <div className="container">
        <div className="row">
          <div className='"card col-md-6 offset-md-3 offset-md-3'>
            <h3 className="text-center"> Update Phones</h3>
            <div className="card-body">
              <form onSubmit={updatePhone}>
                ...
                <button className="btn btn-success" onClick={updatePhone}>
                  Save
                </button>
                <button
...
export default UpdatePhoneComponent;
